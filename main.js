...
function bouncePlayer() {
    ...
    const clip = THREE.AnimationClip.findByName( clips, 'Bounce-Up' );
...
function bouncePlayerRight() {
    const clip = THREE.AnimationClip.findByName( clips, 'Bounce-Right' );
    const action = mixer.clipAction( clip );
    action.reset();
    action.loop = THREE.LoopOnce;
    action.timeScale = 2;
...
function bouncePlayerLeft() {
    const clip = THREE.AnimationClip.findByName( clips, 'Bounce-Left' );
    const action = mixer.clipAction( clip );
    action.reset();
    action.loop = THREE.LoopOnce;
    action.timeScale = 2;
...
function bouncePlayerBack() {
    const clip = THREE.AnimationClip.findByName( clips, 'Bounce-Back' );
    const action = mixer.clipAction( clip );
    action.reset();
    action.loop = THREE.LoopOnce;
    action.timeScale = 2;
...
function bouncePlayerBig() {
    const clip = THREE.AnimationClip.findByName( clips, 'Bounce-Big' );
    const action = mixer.clipAction( clip );
    action.reset();
    action.loop = THREE.LoopOnce;
    action.timeScale = 2;
...
const bounceButton = document.querySelector("#bounceUp");
bounceButton.addEventListener("click", function () {
    bouncePlayer();
})

const bounceRightButton = document.querySelector("#bounceRight");
bounceRightButton.addEventListener("click", function () {
    bouncePlayerRight();
})

const bounceLeftButton = document.querySelector("#bounceLeft");
bounceLeftButton.addEventListener("click", function () {
    bouncePlayerLeft();
})

const bounceBackButton = document.querySelector("#bounceBack");
bounceBackButton.addEventListener("click", function () {
    bouncePlayerBack();
})

const bounceBigButton = document.querySelector("#bounceBig");
bounceBigButton.addEventListener("click", function () {
    bouncePlayerBig();
})